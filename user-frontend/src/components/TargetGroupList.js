...
exerciseList() {
  return this.state.targetgroups.map(currenttargetgroup => {
    return( 
    <Grid item>
    <TargetGroupCard description={currenttargetgroup.description} groupname={currenttargetgroup.groupname} url={currenttargetgroup.imageUrl} id={currenttargetgroup._id}/>
    </Grid>);
  })
}
