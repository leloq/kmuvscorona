...
class DataPrivacy extends Component {
    ...
    render() {
        return (
            ...
            <h3 className="adsimple-311165473">Was genau sind Cookies?</h3>
            ...
            <ul className="adsimple-311165473">
            <li className="adsimple-311165473">Name: _ga</li>
            <li className="adsimple-311165473">Ablaufzeit: 2 Jahre</li>
            <li className="adsimple-311165473">Verwendung: Unterscheidung der Webseitenbesucher</li>
            <li className="adsimple-311165473">Beispielhafter Wert:&nbsp;GA1.2.1326744211.152311165473</li>
            </ul>
            <p>Ein Browser sollte folgende Mindestgrößen unterstützen:</p>
            <ul className="adsimple-311165473">
            <li className="adsimple-311165473">Ein Cookie soll mindestens 4096 Bytes enthalten können</li>
            <li className="adsimple-311165473">Pro Domain sollen mindestens 50 Cookies gespeichert werden können</li>
            <li className="adsimple-311165473">Insgesamt sollen mindestens 3000 Cookies gespeichert werden können</li>
            </ul>
            <h3 className="adsimple-311165473">Welche Arten von Cookies gibt es?</h3>
            ...
            <p><strong className="adsimple-311165473">Unbedingt notwendige Cookies
                <br/>
            ...
            <p><strong className="adsimple-311165473">Funktionelle Cookies
                <br/>
            ...
            <p><strong className="adsimple-311165473">Zielorientierte Cookies
                <br/>
            </strong>Diese Cookies sorgen für eine bessere Nutzerfreundlichkeit. Beispielsweise werden eingegebene Standorte, Schriftgrößen oder Formulardaten gespeichert.</p>
            <p><strong className="adsimple-311165473">Werbe-Cookies
                <br/>
            </strong>Diese Cookies werden auch Targeting-Cookies genannt. Sie dienen dazu dem User individuell angepasste Werbung zu liefern. Das kann sehr praktisch, aber auch sehr nervig sein.</p>
            <p>Üblicherweise werden Sie beim erstmaligen Besuch einer Webseite gefragt, welche dieser Cookiearten Sie zulassen möchten. Und natürlich wird diese Entscheidung auch in einem Cookie gespeichert.</p>
            <h3 className="adsimple-311165473">Wie kann ich Cookies löschen?</h3>
            ...
            <ul className="adsimple-311165473">
            <li className="adsimple-311165473">Recht auf Berichtigung (Artikel 16 DSGVO)</li>
            <li className="adsimple-311165473">Recht auf Löschung („Recht auf Vergessenwerden“) (Artikel 17 DSGVO)</li>
            <li className="adsimple-311165473">Recht auf Einschränkung der Verarbeitung (Artikel 18 DSGVO)</li>
            <li className="adsimple-311165473">Recht auf Benachrichtigung – Mitteilungspflicht im Zusammenhang mit der Berichtigung oder Löschung personenbezogener Daten oder der Einschränkung der Verarbeitung (Artikel 19 DSGVO)</li>
            <li className="adsimple-311165473">Recht auf Datenübertragbarkeit (Artikel 20 DSGVO)</li>
            ...
            <h3 className="adsimple-311165473">Was ist Google Analytics?</h3>
            ...
            <ul className="adsimple-311165473">
            <li className="adsimple-311165473">Zielgruppenberichte: Über Zielgruppenberichte lernen wir unsere User besser kennen und wissen genauer, wer sich für unser Service interessiert.</li>
            <li className="adsimple-311165473">Anzeigeberichte: Durch Anzeigeberichte können wir unsere Onlinewerbung leichter analysieren und verbessern.</li>
            <li className="adsimple-311165473">Akquisitionsberichte: Akquisitionsberichte geben uns hilfreiche Informationen darüber, wie wir mehr Menschen für unser Service begeistern können.</li>
            <li className="adsimple-311165473">Verhaltensberichte: Hier erfahren wir, wie Sie mit unserer Website interagieren. Wir können nachvollziehen welchen Weg Sie auf unserer Seite zurücklegen und welche Links Sie anklicken.</li>
            <li className="adsimple-311165473">Conversionsberichte: Conversion nennt man einen Vorgang, bei dem Sie aufgrund einer Marketing-Botschaft eine gewünschte Handlung ausführen. Zum Beispiel, wenn Sie von einem reinen Websitebesucher zu einem Käufer oder Newsletter-Abonnent werden. Mithilfe dieser Berichte erfahren wir mehr darüber, wie unsere Marketing-Maßnahmen bei Ihnen ankommen. So wollen wir unsere Conversionrate steigern.</li>
            <li className="adsimple-311165473">Echtzeitberichte: Hier erfahren wir immer sofort, was gerade auf unserer Website passiert. Zum Beispiel sehen wir wie viele User gerade diesen Text lesen.</li>
            </ul>
            <h3 className="adsimple-311165473">Warum verwenden wir Google Analytics auf unserer Webseite?</h3>
            ...
            <h3 className="adsimple-311165473">Welche Daten werden von Google Analytics gespeichert?</h3>
            ...
            <p><strong className="adsimple-311165473">Name:</strong> _ga
            <br/><strong className="adsimple-311165473">Wert:</strong>2.1326744211.152311165473-5
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Standardmäßig verwendet analytics.js das Cookie _ga, um die User-ID zu speichern. Grundsätzlich dient es zur Unterscheidung der Webseitenbesucher.
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> nach 2 Jahre</p>
            <p><strong className="adsimple-311165473">Name:</strong> _gid
            <br/><strong className="adsimple-311165473">Wert:</strong>2.1687193234.152311165473-1
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Das Cookie dient auch zur Unterscheidung der Webseitenbesucher
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> nach 24 Stunden</p>
            <p><strong className="adsimple-311165473">Name:</strong> _gat_gtag_UA_&lt;property-id&gt;
            <br/><strong className="adsimple-311165473">Wert:</strong> 1
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Wird zum Senken der Anforderungsrate verwendet. Wenn Google Analytics über den Google Tag Manager bereitgestellt wird, erhält dieser Cookie den Namen _dc_gtm_ &lt;property-id&gt;.
            <br/><strong className="adsimple-311165473">Ablaufdatum:&nbsp;</strong>nach 1 Minute</p>
            <p><strong className="adsimple-311165473">Name:</strong> AMP_TOKEN
            <br/><strong className="adsimple-311165473">Wert:</strong> keine Angaben
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Das Cookie hat einen Token, mit dem eine User ID vom AMP-Client-ID-Dienst abgerufen werden kann. Andere mögliche Werte weisen auf eine Abmeldung, eine Anfrage oder einen Fehler hin.
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> nach 30 Sekunden bis zu einem Jahr</p>
            <p><strong className="adsimple-311165473">Name:</strong> __utma
            <br/><strong className="adsimple-311165473">Wert:</strong>1564498958.1564498958.1564498958.1
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Mit diesem Cookie kann man Ihr Verhalten auf der Website verfolgen und sie Leistung messen. Das Cookie wird jedes Mal aktualisiert, wenn Informationen an Google Analytics gesendet werden.
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> nach 2 Jahre</p>
            <p><strong className="adsimple-311165473">Name:</strong> __utmt
            <br/><strong className="adsimple-311165473">Wert:</strong> 1
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Das Cookie wird wie _gat_gtag_UA_&lt;property-id&gt; zum Drosseln der Anforderungsrate verwendet.
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> nach 10 Minuten</p>
            <p><strong className="adsimple-311165473">Name:</strong> __utmb
            <br/><strong className="adsimple-311165473">Wert:</strong>3.10.1564498958
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Dieses Cookie wird verwendet, um neue Sitzungen zu bestimmen. Es wird jedes Mal aktualisiert, wenn neue Daten bzw. Infos an Google Analytics gesendet werden.
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> nach 30 Minuten</p>
            <p><strong className="adsimple-311165473">Name:</strong> __utmc
            <br/><strong className="adsimple-311165473">Wert:</strong> 167421564
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Dieses Cookie wird verwendet, um neue Sitzungen für wiederkehrende Besucher festzulegen. Dabei handelt es sich um ein Session-Cookie und wird nur solange gespeichert, bis Sie den Browser wieder schließen.
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> Nach Schließung des Browsers</p>
            <p><strong className="adsimple-311165473">Name:</strong> __utmz
            <br/><strong className="adsimple-311165473">Wert:</strong> m|utmccn=(referral)|utmcmd=referral|utmcct=/
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Das Cookie wird verwendet, um die Quelle des Besucheraufkommens auf unserer Website zu identifizieren. Das heißt, das Cookie speichert, von wo Sie auf unsere Website gekommen sind. Das kann eine andere Seite bzw. eine Werbeschaltung gewesen sein.
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> nach 6 Monate</p>
            <p><strong className="adsimple-311165473">Name:</strong> __utmv
            <br/><strong className="adsimple-311165473">Wert:</strong> keine Angabe
            <br/><strong className="adsimple-311165473">Verwendungszweck:</strong> Das Cookie wird verwendet, um benutzerdefinierte Userdaten zu speichern. Es wird immer aktualisiert, wenn Informationen an Google Analytics gesendet werden.
            <br/><strong className="adsimple-311165473">Ablaufdatum:</strong> nach 2 Jahre</p>
            <p><strong className="adsimple-311165473">Anmerkung:</strong> Diese Aufzählung kann keinen Anspruch auf Vollständigkeit erheben, da Google die Wahl ihrer Cookies immer wieder auch verändert.</p>
            <p>Hier zeigen wir Ihnen einen Überblick über die wichtigsten Daten, die mit Google Analytics erhoben werden:</p>
            <p><strong className="adsimple-311165473">Heatmaps:</strong> Google legt sogenannte Heatmaps an. Über Heatmaps sieht man genau jene Bereiche, die Sie anklicken. So bekommen wir Informationen, wo Sie auf unserer Seite „unterwegs“ sind.</p>
            <p><strong className="adsimple-311165473">Sitzungsdauer:</strong> Als Sitzungsdauer bezeichnet Google die Zeit, die Sie auf unserer Seite verbringen, ohne die Seite zu verlassen. Wenn Sie 20 Minuten inaktiv waren, endet die Sitzung automatisch.</p>
            <p><strong className="adsimple-311165473">Absprungrate</strong> (engl. Bouncerate): Von einem Absprung ist die Rede, wenn Sie auf unserer Website nur eine Seite ansehen und dann unsere Website wieder verlassen.</p>
            <p><strong className="adsimple-311165473">Kontoerstellung:</strong> Wenn Sie auf unserer Website ein Konto erstellen bzw. eine Bestellung machen, erhebt Google Analytics diese Daten.</p>
            <p><strong className="adsimple-311165473">IP-Adresse:</strong> Die IP-Adresse wird nur in gekürzter Form dargestellt, damit keine eindeutige Zuordnung möglich ist.</p>
            <p><strong className="adsimple-311165473">Standort:</strong> Über die IP-Adresse kann das Land und Ihr ungefährer Standort bestimmt werden. Diesen Vorgang bezeichnet man auch als IP- Standortbestimmung.</p>
            <p><strong className="adsimple-311165473">Technische Informationen:</strong> Zu den technischen Informationen zählen unter anderem Ihr Browsertyp, Ihr Internetanbieter oder Ihre Bildschirmauflösung.</p>
            ...
            <ul className="adsimple-311165473">
            <li className="adsimple-311165473">Löschung nach 14 Monaten</li>
            <li className="adsimple-311165473">Löschung nach 26 Monaten</li>
            <li className="adsimple-311165473">Löschung nach 38 Monaten</li>
            <li className="adsimple-311165473">Löschung nach 50 Monaten</li>
            <li className="adsimple-311165473">Keine automatische Löschung</li>
            </ul>
            ...
            <ul className="adsimple-311165473">
            <li className="adsimple-311165473">die Adresse (URL) der aufgerufenen Webseite</li>
            <li className="adsimple-311165473">Browser und Browserversion</li>
            <li className="adsimple-311165473">das verwendete Betriebssystem</li>
            <li className="adsimple-311165473">die Adresse (URL) der zuvor besuchten Seite (Referrer URL)</li>
            <li className="adsimple-311165473">den Hostname und die IP-Adresse des Geräts von welchem aus zugegriffen wird</li>
            <li className="adsimple-311165473">Datum und Uhrzeit</li>
            </ul>
